    ...
    <div className='w-full max-w-3xl mx-auto flex items-center justify-between'>
      ...
      <Dialog.Root>
        <Dialog.Trigger
          ...
          flex items-center gap-3 hover:border-violet-300 transition-colors focus:outline-none focus:ring-2
        ...
        <Dialog.Portal>
          ...
          -translate-x-1/2 -translate-y-1/2">
            <Dialog.Close className="absolute right-6 top-6 text-zinc-400 hover:text-zinc-200 rounded-lg
